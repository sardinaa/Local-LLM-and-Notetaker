...
```bash
python demo_job_configs.py --add
```
...
- `python demo_job_configs.py --show` - View current configurations
- `python setup_job_scraper.py` - Full system verification
...
2. Run the diagnostic tools (`setup_job_scraper.py`)
