...
Implements CRUD for agent configurations stored in data/config/agents.json and
...
class AgentsManager:
    def __init__(self, data_service, store_path: str = "data/config/agents.json", ollama_url: str = "http://127.0.0.1:11434"):
